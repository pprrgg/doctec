...
\begin{figure}[H] \centering
                    ...
                    \includegraphics[width=.5\textwidth]{/tmp/tmpggvtysg8.png}
                    \caption{}
...
\begin{figure}[H] \centering
                    ...
                    \includegraphics[width=.5\textwidth]{/tmp/tmppu24f95w.png}
                    \caption{D h6}
...
\begin{figure}[H] \centering
                    ...
                    \includegraphics[width=.5\textwidth]{/tmp/tmpk0pa_wwm.png}
                    \caption{T p}
...
\begin{figure}[H] \centering
                    ...
                    \includegraphics[width=.5\textwidth]{/tmp/tmpt8sbfzor.png}
                    \caption{Serie1}
...
\begin{figure}[H] \centering
                    ...
                    \includegraphics[width=.5\textwidth]{/tmp/tmpsrhf94ck.png}
                    \caption{Serie}
...
\begin{figure}[H] \centering
                    ...
                    \includegraphics[width=.5\textwidth]{/tmp/tmpn4675d48.png}
